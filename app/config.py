...
class Settings(BaseSettings):
    ...
    db_pool_size: int = Field(default=5, ge=1, le=10)  # Conservative for shared hosting
    ...
    webauthn_rp_name: str = Field(default="Stop Spying On Me", alias="WEBAUTHN_RP_NAME")
    webauthn_origin: str = Field(default="http://localhost:8000", alias="WEBAUTHN_ORIGIN")
